...
const ZOOM = 1;         // cámara cercana, personajes grandes (como Maximum Carnage en SNES)
const VW = W / ZOOM, VH = H / ZOOM; // tamaño de la vista en unidades de mundo
const SPR_D = 1;        // píxeles de sprite por unidad de mundo (alta definición: medio píxel de pantalla)
